//The overall setting is the same as 'Sk8er_Boi_High.js'. Please refer to that for explanation of the annotation
//The difference is that the 'visual()' effect is deleted Also, some neon sign effect has eliminated.
//Because the two effects use graphics a lot, So I deliberately removed them in 'Medium spec mode'.
